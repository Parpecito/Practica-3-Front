...
import MostrarDatosLogin from "../../components/MostrarDatosLogin.tsx";
...
export default function Page(props:PageProps<Usuario>){
    ...
    return(
      <MostrarDatosLogin name={name} age={age} sex={sex} description={description} hobbies={hobbies} photo={photo} comments={comments} ></MostrarDatosLogin>
    )
